...
class ApplyForVisitVisa extends StatefulWidget {
  var agentId;
  ApplyForVisitVisa(this.agentId);
  @override
  _ApplyForVisitVisaState createState() => _ApplyForVisitVisaState();
}

class _ApplyForVisitVisaState extends State<ApplyForVisitVisa> {
   ...
   return MaterialApp(
     ...
     home: Scaffold(
        appBar: AppBar(
          ...
          title: visaType==null?Text('Visit Visa'):Text("${visaType} Visa"),
          centerTitle: true,
        ),
        body:  SafeArea(
          child: Column(
  ...
  continued(){
    if(_currentStep==0 && passengerInfoFormKey.currentState.validate()){
      ...
      setState(() {
        ...
        // mapOfVisaApplyDetails['user_id']=userID;
